...
- Graph BFS, Coin Change Memo DFS, and Tree DFS Traversal now use explicit shared view-spec contracts for `primary` / `co-primary` / `support` instead of inheriting stage placement from legacy `secondary` defaults
